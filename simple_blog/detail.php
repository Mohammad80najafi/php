        ...
        <section class="container my-5">
            ...
            <section class="row">
                <section class="col-md-12">
                    <?php
                    global $pdo;
                    $query = "SELECT posts.*, categories.name AS category_name FROM simple_blog.posts JOIN categories ON posts.cat_id = categories.id WHERE posts.status = 10 AND posts.id = ?;";
